...
public class UpdateNoticeAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int noticeSq = Integer.parseInt(request.getParameter("sq"));
		...
		NoticeVo vo = svc.getNoticeInfo(noticeSq);
		...
		vo.setNotice_cntnt(Paser.chgToHTML(vo.getNotice_cntnt()));
		request.setAttribute("vo", vo);
		
		ActionForward forward = new ActionForward();
		forward.setPath("/views/admin/updatenotice.jsp");
		return forward;
