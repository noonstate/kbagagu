...
public class ManageItemAction implements Action {
	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		Pagenation pagenation = new Pagenation(page, svc.getItemCount(query));
		...
		ArrayList<ItemVo> iar= svc.getItemList(pagenation,query);
		
		request.setAttribute("pagenation", pagenation);
		request.setAttribute("iar", iar);
		ActionForward forward = new ActionForward();
		forward.setPath("/views/admin/manageitem.jsp");
		return forward;
	}
}
